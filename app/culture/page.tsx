    ...
    <main className="min-h-screen bg-gradient-to-b from-[#120c06] via-[#1a1009] to-[#2a1a0c] text-white">
      ...
      <section className="max-w-7xl mx-auto px-4 md:px-10 py-14">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {[
            {title: "Di sản", desc: "Di sản vật thể & phi vật thể UNESCO", image: "https://cdn.tienphong.vn/images/a6bf4f60924201126af6849ca45a39805f374379f7857a0f99accf283d00f33843a42a2f8092de8320de2a1462b33557d72b5f1feaa821cf56fc1792750bc6cc16c8877b7786236b6ada0347396aec6e4ffbf2a89e0e2b57e8a4dadf8d58b48c195c5fe6d520984eb09ce86f9b1c1fbb/z6694153730445-6d1c355c6824382452e78ed187cf7750-5813-5729.jpg", link: "/heritage" },
            { title: "Trang phục", desc: "Áo dài, thổ cẩm, sắc phục dân tộc", image: "https://bvhttdl.mediacdn.vn/291773308735864832/2022/11/18/la-hu-16687504593971950567539-1668757766339-1668757766418130402471.jpg", link: "/costume" },
            {title: "Nghệ thuật", desc: "Nhạc cụ, sân khấu, lễ hội", image: "https://bvhttdl.mediacdn.vn/zoom/600_315/2021/1/28/dan-trung-1611826501304704364989-crop-16118265123241222963276.png", link: "/art" },
            {title: "Ẩm thực", desc: "3 miền – ẩm thực thành thương hiệu", image: "https://paoquan.vn/wp-content/uploads/2023/07/mam-co-nguoi-thai.jpg", link: "/cuisine" },
          ].map((p) => {
            const CardContent = (
              <Card className={`p-0 bg-black/30 border border-amber-800/40 overflow-hidden group ${p.link ? 'cursor-pointer hover:border-amber-600/60 hover:shadow-lg hover:shadow-amber-900/20 transition-all duration-300 hover:-translate-y-1' : ''}`}>
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-10">
          ...
          <div className="grid md:grid-cols-4 gap-4">
            {[
              ...
              <Card key={i.name} className="p-0 border border-amber-800/40 bg-black/30 overflow-hidden group">
                <div className="relative overflow-hidden">
                  <img src={i.image} alt={i.name} className="w-full h-28 object-cover transition-transform duration-500 ease-in-out group-hover:scale-110" />
                </div>
                <div className="p-4">
      ...
      <section className="max-w-7xl mx-auto px-4 md:px-10 py-14">
        <div className="grid md:grid-cols-2 gap-6 items-center">
          <div className="relative overflow-hidden rounded-xl border border-amber-800/40 group">
            <img src="https://cdn.24h.com.vn/upload/1-2021/images/2021-02-17/anh-7-1613533743-364-width650height975.jpg" alt="Integration" className="w-full h-72 md:h-96 object-cover transition-transform duration-500 ease-in-out group-hover:scale-110" />
          </div>
      ...
      <section className="max-w-7xl mx-auto px-4 md:px-10 py-14">
        ...
        <div className="grid md:grid-cols-4 gap-4">
          {[
            ...
            <Card key={item.title} className="p-0 border border-amber-800/40 bg-black/30 overflow-hidden group">
              <div className="relative overflow-hidden">
                <img src={item.image} alt={item.title} className="w-full h-28 object-cover transition-transform duration-500 ease-in-out group-hover:scale-110" />
              </div>
