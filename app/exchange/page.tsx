  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-[#120c06] via-[#1a1009] to-[#2a1a0c] text-amber-100">
        ...
        <div className="grid md:grid-cols-3 gap-4">
          {[
            ...
            <Card key={c.title} className="p-0 bg-black/30 border border-amber-800/40 overflow-hidden">
              ...
              <div className="p-5">
                <div className="mt-1 font-semibold text-amber-100">{c.title}</div>
                <div className="text-sm text-amber-200/80">{c.desc}</div>
              </div>
            </Card>
          ))}
        </div>
      ...
      <section className="bg-gradient-to-b from-[#1a1009] to-[#2a1a0c] py-14">
        <div className="max-w-7xl mx-auto px-4 md:px-10 grid md:grid-cols-2 gap-6 items-center">
          ...
          <div>
            ...
            <div className="grid sm:grid-cols-2 gap-x-6 gap-y-2 text-sm text-amber-200/90">
      ...
      <section id="examples" className="max-w-7xl mx-auto px-4 md:px-10 py-14">
        ...
        <p className="text-amber-200/85 mb-4">Hội nhập giúp văn hoá trở thành sản phẩm kinh tế.</p>
        <div className="grid md:grid-cols-4 gap-4">
          {[
            ...
            <Card key={i} className="p-0 bg-black/30 border border-amber-800/40 overflow-hidden">
              ...
              <div className="p-4">
                <div className="font-semibold text-amber-100">{r.left}</div>
                <div className="text-sm text-amber-200/80">{r.right}</div>
              </div>
            </Card>
          ))}
        </div>
      ...
      <section className="bg-gradient-to-b from-[#2a1a0c] to-[#120c06] py-14">
        <div className="max-w-5xl mx-auto px-4 md:px-10 text-center space-y-4">
          ...
          <div className="grid md:grid-cols-3 gap-4 text-amber-200/90">
